...
import { useSuppliers, useSupplierEvaluations, useSupplierClassificationView, useMutation } from '../lib/hooks';
      ...
      <ScrollView style={s.container} contentContainerStyle={s.content}>
        ...
        {classLoading ? (
          ...
          suppliers.map(sup => {
            ...
            // Calculer la classe
            const overallScore = classificationItem?.overall_score ?? (supEvals.length > 0 ? (supEvals.reduce((s, e) => s + e.score, 0) / supEvals.length) : 0);
                  ...
                  <View style={s.supDetail}>
                    ...
                    <View style={{ gap: 12, marginBottom: 16 }}>
                      {Object.entries(CRITERIA_LABELS).map(([key, label]) => {
                        ...
                        return (
                          <View key={key} style={s.evalRow}>
                            <Text style={s.evalLabel}>{label}</Text>
